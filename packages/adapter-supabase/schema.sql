...
RETURNS TRIGGER AS $$
BEGIN
    -- Example logic to determine which table to insert into
    -- You can customize this logic based on your requirements
    IF NEW.embedding::text LIKE '%1536%' THEN
